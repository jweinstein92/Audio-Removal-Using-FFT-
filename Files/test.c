...
int main(int argc, char *argv[]) {
	...
	fftw_plan plan4 = fftw_plan_dft_r2c_1d(nPoint, sample_array, fftw_ryy, FFTW_MEASURE);
	fftw_execute(plan4);
	...
	fftw_plan plan5 = fftw_plan_dft_c2r_1d(nPoint, final_ryy, ryy, FFTW_MEASURE);
	fftw_execute(plan5);
	...
	fftw_plan plan6 = fftw_plan_dft_r2c_1d(lenCon, x_pad, X, FFTW_MEASURE);
	fftw_execute(plan6);
	...
	fftw_plan plan7 = fftw_plan_dft_r2c_1d(lenCon, x_pad, Y, FFTW_MEASURE);
	fftw_execute(plan7);
